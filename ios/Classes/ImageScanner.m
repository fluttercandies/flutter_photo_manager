  ...
  dispatch_async(_asyncQueue, ^{
    ...
    [manager requestImageForAsset:asset
                    ...
                    resultHandler:^(UIImage *result, NSDictionary *info) {
                      ...
                      //                [self writeThumbFileWithAssetId:asset
                      //                imageData:data];
                      //            });
    ...
    [[PHImageManager defaultManager]
        requestAVAssetForVideo:asset
                 ...
                 resultHandler:^(AVAsset *_Nullable asset, AVAudioMix *_Nullable audioMix,
                   ...
                   NSData *beforeVideoData =
                       [NSData dataWithContentsOfURL:fileRUL];  //未压缩的视频流
                   BOOL createResult = [manager createFileAtPath:path
                                                        contents:beforeVideoData
                                                      attributes:@{}];
