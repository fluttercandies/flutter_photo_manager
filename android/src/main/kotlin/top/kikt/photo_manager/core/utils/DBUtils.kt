package top.kikt.photo_manager.core.utils
...
import top.kikt.photo_manager.core.PhotoManager
import top.kikt.photo_manager.core.cache.CacheContainer
import top.kikt.photo_manager.core.entity.AssetEntity
import top.kikt.photo_manager.core.entity.FilterOption
import top.kikt.photo_manager.core.entity.GalleryEntity
import top.kikt.photo_manager.core.utils.IDBUtils.Companion.storeBucketKeys
import top.kikt.photo_manager.core.utils.IDBUtils.Companion.storeImageKeys
import top.kikt.photo_manager.core.utils.IDBUtils.Companion.storeVideoKeys
import top.kikt.photo_manager.core.utils.IDBUtils.Companion.typeKeys
import java.io.*
...
object DBUtils : IDBUtils {
    ...
    override fun getOnlyGalleryList(
        ...
        val cursor =
            context.contentResolver.query(allUri, projection, selections, args.toTypedArray(), null)
                ?: return list
    ...
    override fun saveImage(
        ...
        val insertUri =
            cr.insert(MediaStore.Images.Media.EXTERNAL_CONTENT_URI, values) ?: return null
        val id = ContentUris.parseId(insertUri)

        // write bytes
        val cursor =
            cr.query(insertUri, arrayOf(MediaStore.Images.ImageColumns.DATA), null, null, null)
                ?: return null
    ...
    override fun removeAllExistsAssets(context: Context): Boolean {
        ...
        deleteLock.withLock {
            ...
            val queryCursor =
                cr.query(allUri, arrayOf(_ID, MediaStore.MediaColumns.DATA), null, null, null)
                    ?: return false
            queryCursor.use {
            ...
            // Remove exists rows.
            val deleteRowCount =
                cr.delete(allUri, "$_ID in ( $idWhere )", removedList.toTypedArray())
